    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עורכי דין נדב שלוש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b0487454-a06c-4aaa-bafc-391afe3478a6',
                    name: data.name || '',
                    email: data.email || '',
